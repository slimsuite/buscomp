...
# BUSCOMP Run Summary
    ...
    BUSCOMP V0.7.4: run Fri Jun 28 15:02:50 2019
...
```{r HighQualitybuscochart, echo=FALSE, fig.width=12, fig.height=7}
...
```{r BUSCOMPbuscochart, echo=FALSE, fig.width=12, fig.height=8}
# BUSCOMP c(1,2,3,5,6)
...
```
BUSCOMP BUSCOMP Results [1689 (98.71%) Complete BUSCOs; No BUSCOMP compilation]:
        C:99.9%[S:99.8%,D:0.1%],F:0.0%,P:0.1%,G:0.0%,M:0.0%,n:1681

HighQuality BUSCOMP Results [1684 (98.42%) Complete BUSCOs; No BUSCOMP compilation]:
        C:99.9%[S:99.8%,D:0.1%],F:0.0%,P:0.1%,G:0.0%,M:0.0%,n:1681

PacBioHQ BUSCOMP Results [1684 (98.42%) Complete BUSCOs; No BUSCOMP compilation]:
        C:99.9%[S:99.8%,D:0.1%,I:95.8%],F:0.0%,P:0.1%,G:0.0%,M:0.0%,n:1681

PacBioWTDBG2 BUSCOMP Results [1384 (80.89%) Complete BUSCOs; No BUSCOMP compilation]:
        C:99.9%[S:99.8%,D:0.1%,I:60.6%],F:0.0%,P:0.1%,G:0.0%,M:0.0%,n:1681

SGD BUSCOMP Results [1683 (98.36%) Complete BUSCOs; No BUSCOMP compilation]:
        C:99.9%[S:99.8%,D:0.1%,I:95.7%],F:0.0%,P:0.1%,G:0.0%,M:0.0%,n:1681

chrIIIdup BUSCOMP Results [45 (2.63%) Complete BUSCOs; No BUSCOMP compilation]:
...
# HighQuality c(1,2,3,4)sumdata = ratings[c(1,2,3,4),c(1,5:10)+1]
colnames(sumdata) = c("Dataset", "Complete", "Duplicated", "Fragmented", "Missing")
buscompSeqPercPlot(sumdata,"HighQuality BUSCO Rating Summary",maketext=TRUE)

```

```{r BUSCOMPbuscompchart, echo=FALSE, fig.width=12, fig.height=8}
# BUSCOMP c(1,2,3,5,6)sumdata = ratings[c(1,2,3,5,6),c(1,5:10)+1]
colnames(sumdata) = c("Dataset", "Complete", "Duplicated", "Fragmented", "Missing")
buscompSeqPercPlot(sumdata,"BUSCOMP BUSCO Rating Summary",maketext=TRUE)
...
```
#WARN	00:00:05	"Single copy" BUSCO EOG092E01WO has 2+ sequences in ../busco3/run_MBG344001/single_copy_busco_sequences/EOG092E01WO.fna! (Keeping first.)
#WARN	00:00:05	"Single copy" BUSCO EOG092E01WO has 2+ sequences in ../busco3/run_MBG344001/single_copy_busco_sequences/EOG092E01WO.faa! (Keeping first.)
...
<small>Output generated by BUSCOMP v0.7.4 &copy; 2019 Richard Edwards | richard.edwards@unsw.edu.au</small>
