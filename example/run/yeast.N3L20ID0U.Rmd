...
# BUSCOMP Run Summary
    ...
    BUSCOMP V0.8.0: run Mon Aug 19 19:59:44 2019



See the <a href="#Appendix">run details appendix</a> end of this document for details of the <a href="/Users/redwards/Documents/Projects/BUSCOMP-Jan19/code/buscomp/example/run/yeast.log">log file</a>, <a href="#Appendix">commandline parameters</a> and runtime <a href="#Errors">BUSCOMP errors and warnings</a>.
...
genstat = gentable[! is.na(gentable$SeqNum),c(4,9:20)]
...
buscoPercPlot(sumdata,"BUSCO Rating Summary",maketext=FALSE)
...
buscompSeqPercPlot(sumdata,"BUSCOSeq Rating Summary",maketext=FALSE)
...
This analysis was run in:
    ...
    /Users/redwards/Documents/Projects/BUSCOMP-Jan19/code/buscomp/example/run

* Log file: <a href="/Users/redwards/Documents/Projects/BUSCOMP-Jan19/code/buscomp/example/run/yeast.log">`/Users/redwards/Documents/Projects/BUSCOMP-Jan19/code/buscomp/example/run/yeast.log`</a>
* Commandline arguments: `ini=../run/example.ini` `i=-1` `forks=4`
* Full Command List: `minimap2=/Users/redwards/Bioware/minimap2/minimap2` `ini=../run/example.ini` `genomesize=13.1e6` `genomes=../example.genomes.csv` `groups=../example.groups.csv` `runs=../busco3/run_*` `fastadir=../fasta/` `basefile=yeast` `i=-1` `forks=4`
...
#WARN	00:00:04	alnseq=F mode is developmental - please report odd behaviour.
#WARN	00:00:08	31 end extensions (endextend=10): may be some minor identity underestimates.
#WARN	00:00:39	alnseq=F mode is developmental - please report odd behaviour.
#WARN	00:00:44	31 end extensions (endextend=10): may be some minor identity underestimates.
#WARN	00:01:14	alnseq=F mode is developmental - please report odd behaviour.
#WARN	00:01:15	4 end extensions (endextend=10): may be some minor identity underestimates.
#WARN	00:01:17	alnseq=F mode is developmental - please report odd behaviour.
#WARN	00:01:21	40 end extensions (endextend=10): may be some minor identity underestimates.
```
...
<small>Output generated by BUSCOMP v0.8.0 &copy; 2019 Richard Edwards | richard.edwards@unsw.edu.au</small>
